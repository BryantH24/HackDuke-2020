...
#     print(trump_predictions)
    ...
    # print(get_tweets_predictions("nigga"))
    # print(get_tweets_predictions("i lvoe people"))
    # print(get_tweets_predictions("brown bagging"))
    # print(get_tweets_predictions("trump 2020"))
    # print(get_tweets_predictions("fortnite lyfe"))
